...
const ProductCard = ({ product }) => {
  return (
    <div className="flex flex-wrap ml-[2rem] mt-[2rem] font-poppins">
      <div className="m-[20px] shadow-md flex flex-col items-center justify-center border-2 border-[#ededed] p-[20px] cursor-pointer max-w-[333px] max-h-[480px] transition-transform duration-300 transform hover:scale-105 hover:shadow-lg">
        <img
